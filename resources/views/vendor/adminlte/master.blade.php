...
<head>
    ...
    {{-- Base Stylesheets --}}
    @if(!config('adminlte.enabled_laravel_asset_bundling'))
    ...
    @if(Session::get('direction', 'ltr') === 'rtl')
...
<body class="@yield('classes_body') {{ Session::get('direction', 'ltr') === 'rtl' ? 'rtl' : '' }}" @yield('body_data')>
